...
- Name: app.spec.js >> Min Messenger E2E Tests >> should redirect to login when accessing protected route
- Location: tests/e2e/app.spec.js:168:3
...
Call log:
  - Expect "toHaveURL" with timeout 5000ms
    9 × unexpected value "http://localhost:3000/messages"
...
```yaml
- generic [ref=e5]:
  - heading "Messages" [level=2] [ref=e6]
  - generic [ref=e7]:
    - generic [ref=e8]: Channel
    - combobox [ref=e9]:
  ...
  - generic [ref=e15]: Failed to load messages
```
